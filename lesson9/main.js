...
simpsons.forEach(value => {
    ...
    name.innerText = value.name + ' ' + value.surname

    const age = document.createElement('h3')
    age.innerText = value.age

    const descr = document.createElement('p')
    descr.innerText = value.info

    const a = document.createElement('a')
    a.setAttribute('href', `${value.photo}`)
    a.innerText = 'Link'

    div.append(name, age, descr, a)
    document.body.append(div)
})
...
coursesArray.forEach(value => {
    ...
    secondDiv.append(monthDuration, hourDuration)
    const modulesDiv = document.createElement('div')
    const modulesUl = document.createElement('ul')

    value.modules.forEach(valueModules => {
        const mudulesLi = document.createElement('li')
        mudulesLi.innerText = valueModules
        modulesUl.append(mudulesLi)
    })
    modulesDiv.append(modulesUl)

    mainDiv.append(title, secondDiv, modulesDiv)
